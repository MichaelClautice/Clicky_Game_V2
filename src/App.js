// Clicky_Game_V2
// Written by Michael Clautice 2018
...
class App extends Component {
  ...
  state = {
    guessArray: [],
    message: "Click any fish to begin!",
    score: 0,
    topScore: 0,
    shake: 0
  };
  ...
  clickCard = card => {
    ...
    if (guessArray[card.id]) {
      this.setState({
        message: "You've already clicked on that photo! Starting over!",
  ...
  render() {
    return (
      <div>
        ...
        <Jumbotron />
        {/* Wrong answer will "reshake" the page */}
